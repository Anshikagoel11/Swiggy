...
export default function ResaurantHeader({id}){
  ...
  {/* Main Content */}
  <div className="mb-4">
    <h1 className="text-xl sm:text-2xl font-bold mb-2">{finalData?.name}</h1>
      ...
      {finalData2?.map((deal, index) => (
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="font-medium text-sm">{deal?.info?.header}</div>
  ...
  {/* Menu Section */}
  <div className="text-center mt-8 mb-6 text-base font-semibold">
    MENU
  </div>
